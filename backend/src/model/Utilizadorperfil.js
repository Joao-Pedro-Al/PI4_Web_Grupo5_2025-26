...
const Utilizadorperfil = sequelize.define('utilizadorprefil', { // Nome exato do SQL
  idutilizadorprefil: {
    type: Sequelize.INTEGER,
    primaryKey: true,
    autoIncrement: true
  },
  nome: { type: Sequelize.STRING, field: 'nome' },
  gmail: { type: Sequelize.STRING, field: 'gmail' },
  nif: { type: Sequelize.STRING, field: 'nif' },
  profissao: { type: Sequelize.STRING, field: 'profissao' },
  datanascimento: { type: Sequelize.DATEONLY, field: 'datanascimento' },
  
  // DECLARAÇÃO OBRIGATÓRIA PARA GRAVAR
  genero: { type: Sequelize.INTEGER, field: 'genero' },
  estadocivil: { type: Sequelize.INTEGER, field: 'estadocivil' },
  classe: { type: Sequelize.INTEGER, field: 'classe' }
}, {
  freezeTableName: true,
  timestamps: false
});
